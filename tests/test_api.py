...
# Ajusta o PYTHONPATH:
# raiz do projeto (para "app" ser pacote)
# e app/ (para os imports internos de main.py,
# como "from schemas import ...")
...
class TestPredictEndpoint:
    ...
    def test_predict_detects_at_least_one_object(
        self,
        zidane_b64,
    ):
        """
        A imagem zidane.jpg deve produzir
        ao menos 1 detecção com conf >= 0.3.
        """
    ...
    def test_predict_response_schema(self, zidane_b64):
        """
        Resposta deve conter todos os campos
        do schema PredictResponse.
        """
    ...
    def test_predict_detection_fields(
        self,
        zidane_b64,
    ):
        """
        Cada detecção deve ter
        label, confidence e bbox válidos.
        """
...
class TestBatchEndpoint:
    ...
    def test_batch_total_ms_is_positive(
        self,
        two_images_b64,
    ):
        data = client.post(
